...
public class ProjectUpdateForm {
    ...
    /**
     * ProjectDtoの値をこのFormにコピーする。
     * @param projectDto コピー元のdto
     */
    public void copyFrom(ProjectDto projectDto) {
     ...
     */
    @AssertTrue(message = "{validator.periodConsistencyCheck.message.ProjectUpdateForm}")

 ...
 * これによりセルフチェック用のクラス（com.example.batch.archunit.selfcheck）がテスト対象となる。
 */
class ArchUnitConfiguration {
    ...
    private static JavaClasses createTargetJavaClasses() {
        ...
        return Boolean.parseBoolean(selfCheck) ? createArchUnitSelfCheckClasses() : createAppJavaClasses();
    }
     ...
     */
    private static JavaClasses createAppJavaClasses() {
    ...
    private static JavaClasses createArchUnitSelfCheckClasses() {
        return new ClassFileImporter()
                ...
                .importPackages("com.example.batch.archunit.selfcheck");
    }
}
